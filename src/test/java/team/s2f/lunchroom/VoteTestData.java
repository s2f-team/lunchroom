...
public class VoteTestData {
    ...
    public static final Vote vote_user1 = new Vote(100022, LocalDate.now(), UserTestData.USER_ID1, 100003, 100008);
    public static final Vote vote_user2 = new Vote(100023, LocalDate.now(), UserTestData.USER_ID2, 100006, 100011);
    public static final Vote vote_admin = new Vote(100024, LocalDate.now(), UserTestData.ADMIN_ID, 100006, 100011);
